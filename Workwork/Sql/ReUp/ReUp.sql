    ...
    SELECT 
        ...
        (
            ...
            WHERE
                ...
                (
                    SELECT 
                        MAX(sfbetrm_ests_date) OVER(PARTITION BY sfbetrm_pidm, sfbetrm_term_code)
                    FROM 
                        sfbetrm
...
FROM 
    ...
    -- Enrollment
    LEFT JOIN w_sfbetrm ON w_sfbetrm_pidm = goradid_pidm
    LEFT JOIN stvests ON stvests_code = w_sfbetrm_ests_code
    -- Graduation
