...
SELECT DISTINCT
    ...
    CASE
            WHEN ssbsect_schd_code IN ( '04', '06', '08', '10', '11',
                                        '28' ) THEN
                'INDV'
            WHEN ssbsect_schd_code IN ( '22', '23', '23A', '31', '22A',
                                        '30', '27A', '26A', '27', '26',
                                        '33', '32', '33A', '32A', '31A',
                                        '30A' ) THEN
                'BLND'
    ...
    gobtpac_external_user || '@nsuok.edu'     AS "Instructor",
    to_char(stvterm_start_date, 'MM/DD/YYYY') AS "Start_Date",
...
WHERE
    ssbsect_ssts_code = 'A'
    AND stvterm_code = :main_lb_terms.stvterm_code
