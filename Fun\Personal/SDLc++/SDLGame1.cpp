...
int main(int argc, char* argv[]) {
    ...
    SDL_Window* window = SDL_CreateWindow("100% fully featured game", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, WIDTH, HEIGHT, SDL_WINDOW_ALLOW_HIGHDPI);
    ...
    // Supposed to set icon but isn't working right now..
    SDL_Surface* icon = IMG_Load("C:\\Users\\berresg\\Desktop\\download\\1ae0cfcec29aaff9.bmp");
    ...
    while (true) {
        ...
        SDL_Surface* textSurface = TTF_RenderText_Solid(font, "Plont", textColor);
